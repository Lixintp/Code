<?php
/*
* 该类对外公开的方法只有一个 outImage,只要调用这个方法，就可以将验证码显示到浏览器
* 有些变量在该类里面会被反复的使用到，将其设置成成员属性，将不用公开的成员属性设置为protected
* @name Model
* @author phpT<li.php@outlook.com>
*/
